# Welcome to Fastify Secrets Azure!
...
In order to run the tests you will need access to an Azure Key Vault instance. Refer to the readme for how to set up the environment and which environment variables are necessary. You can provide them using a local `.env` file, which you can create by copying `.env.sample`.
